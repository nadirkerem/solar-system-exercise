...
console.log(`1. Jupiter's moons: ${solarSystem[4].moons}`);

// 2. Print the name of Neptune's moon "Nereid" to the console.
console.log(`2. Neptune's moon "Nereid": ${solarSystem[7].moons[1]}`);
console.log(solarSystem[7].moons[1]);

// 3. Add a new moon called "Endor" to Venus' moons array.
solarSystem[1].moons.push('Endor');
console.log(`3. Venus' moons: ${solarSystem[1].moons}`);
...
console.log(
  `4. ${solarSystem[8].name} has ${solarSystem[8].moons.length} moon: ${solarSystem[8].moons}`
);
...
solarSystem[2] = { ...solarSystem[2], diameter: '7,917.5 miles' };
console.log(`5. Earth's diameter: ${solarSystem[2].diameter}`);

// 6. Change Mercury's ringSystem boolean to true.
solarSystem[0] = { ...solarSystem[0], ringSystem: true };
console.log(`6. Mercury's ringSystem: ${solarSystem[0].ringSystem}`);

// 7. Change Uranus' moon "Umbriel" to "Oberon"
solarSystem[6].moons[3] = 'Oberon';
console.log(`7. Uranus' moons: ${solarSystem[6].moons}`);
...
const ringSystemPlanets = solarSystem.filter(
  (planet) => planet.ringSystem === true
);
console.log('8. Planets with ring system:', ringSystemPlanets);
// or
...
for (const planet in system) {
  if (
    ...
    satellitesSum2 += parseInt(system[planet].satellites);
  }
}
console.log(`3. Sum of satellites: ${satellitesSum2}`);
...
console.log(`5. Mercury's radiusp: ${system.mercury.radiusp}`);
...
const momentumDifference = Math.abs(momentumOfJupiter - momentumOfPluto);
console.log(
  `6. Difference between Jupiter's and Pluto's momentum: ${momentumDifference}`
);
